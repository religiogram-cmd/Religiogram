...
/**
 * Step — Basic details (shared across priest / astrologer / both flows).
 *
 * Fields: Full Name, DOB, Phone, City.
 * Each input sits on its own row — paired fields are harder to hit on
 * small screens for older users, who are our target demographic.
 */
...
export default function Step_BasicDetails({ flow }: { flow: FlowConfig }) {
