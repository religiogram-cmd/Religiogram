...
/**
 * Step 3 — Faith / religion selection.
 *
 * This is the GATE for Step 4: the next-step route refuses to render
 * the services picker until a religion is set. Enforced both client-side
 * (`canContinue`) and server-side (`assertReligionSet` in the service).
 *
...
export default function Step3Page() {
  ...
  const onContinue = async () => {
    ...
    setErr(null);
    try {
      // If the user is switching religions, services will be cleared server-side.
      if (
        data.religion &&
