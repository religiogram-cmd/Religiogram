...
const NAV: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2 L2 22 L22 22 Z" /><line x1="12" y1="9" x2="12" y2="14" /><line x1="12" y1="18" x2="12.01" y2="18" />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M20 12V6a2 2 0 0 0-2-2H5a2 2 0 0 0 0 4h15a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6" />
        <circle cx="17" cy="14" r="1.5" />
      </svg>
    ),
    match: (p) => (p ?? '').startsWith('/admin/wallet'),
  },
  {
