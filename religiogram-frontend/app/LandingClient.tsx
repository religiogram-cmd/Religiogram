...
/**
 * Client-side implementation of the public landing page at `/`.
 *
 * Split out of `app/page.tsx` so that page.tsx can be a Server Component
 * and export route-specific `metadata` + inline JSON-LD structured data.
 * Everything interactive (useState, useEffect, useRef, event handlers,
 * hero video autoplay) lives here.
 *
